<x-guest-layout>
    ...
    {{-- >>> KODE FINAL FIX: MENAMPILKAN PESAN DARI QUERY STRING (request()->has('registered')) <<< --}}
    @if (request()->has('registered'))
        <div class="mb-4 font-medium text-sm p-3 rounded-md bg-green-100 dark:bg-green-800 text-green-700 dark:text-green-400 border border-green-400 dark:border-green-600">
